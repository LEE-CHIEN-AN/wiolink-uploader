...
.env-bad   { background:#ff6b6b; color:#FFE8E8; }  /* 超標 */
...
.iaqi-very       { background:#FF920E;  color:#3c1200; }  /* red-orange Very Polluted 21–40 */
.iaqi-severe     { background:#ff6b6b; color:#fff; }  /* deep magenta Severe 0–20 */
.iaqi-chip {
