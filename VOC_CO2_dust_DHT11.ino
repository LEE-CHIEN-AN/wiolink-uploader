...
//IPAddress PGIP(10,138,177,129);  //connect my phone wifi's IP
      ...
      */
      ...
      if (pg_status == 2) {
        snprintf(inbuf, sizeof(inbuf),
          "insert into sensor_arduino (name,temp,humidity,dust,total_voc,co2eq) "
          "values('407_air_quality',%.2f,%d,%.2f,%d,%d)",
          t, h, dust,tvoc_ppb,co2_eq_ppm); // ← 修正後加入 touch
